      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="item-drawer">
          <div className="drawer-top">
            ...
            <Dialog.Close className="icon-button" disabled={saving} aria-label="Закрыть карточку">
              <X size={22} />
            </Dialog.Close>
          </div>
          ...
          {error ? (
            ...
            <>
              <div className="drawer-tags">
                ...
                <Badge tone="scenario">Синтетический пример</Badge>
              </div>
                ...
                {tab === 'overview' && (
                  <>
                    <div className="recommendation-callout">
                      <div>
                        <span>Рекомендуем к закупке</span>
                        <strong>
                          {number(detail.item.recommended_quantity)}{' '}
